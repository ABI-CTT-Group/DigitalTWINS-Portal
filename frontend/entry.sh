...
# ----------------------------
: "${BACKEND_HOST_IP:=localhost}"       # Backend IP or hostname
...
# ----------------------------
# Example: if your index.html contains %BACKEND_HOST_IP% placeholders
# sed -i "s|%BACKEND_HOST_IP%|${BACKEND_HOST_IP}|g" /usr/share/nginx/html/index.html
