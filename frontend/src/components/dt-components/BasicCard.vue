...
const emit = defineEmits(["ExploreClicked", "AssayEditClicked", "AssaySave", "AssayLaunchClicked", "AssayMonitorClicked", "AssayVerifyClicked", "AssayDownloadClicked", "AssayUploadClicked"]);
